...
`docs/90-notes/archive/` 保存各模块的详细历史文档、实施细节和迁移参考。

归档文档不直接作为当前实现契约；当前权威说明仍以 `docs/10-product/`、`docs/20-design/`、`docs/30-contracts/` 和 `docs/40-implementation/modules/` 为准。
...
- 需要了解模块当前定位时，先读 `docs/40-implementation/modules/<module>/README.md`。
