...
- 修改模块功能逻辑时，同步更新 `docs/40-implementation/modules/<module>/README.md`。
- 修改 API、DB、A2UI、shared 类型时，同步更新 `docs/30-contracts/`。
...
- Frontend：[../../40-implementation/modules/frontend/README.md](../../40-implementation/modules/frontend/README.md)
- Renderer：[../../40-implementation/modules/renderer/README.md](../../40-implementation/modules/renderer/README.md)
- Backend：[../../40-implementation/modules/backend/README.md](../../40-implementation/modules/backend/README.md)
- Agent：[../../40-implementation/modules/agent/README.md](../../40-implementation/modules/agent/README.md)
- Shared：[../../40-implementation/modules/shared/README.md](../../40-implementation/modules/shared/README.md)
