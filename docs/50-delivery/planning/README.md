...
`50-delivery/planning/` 用于保存每次功能新增、功能修改、迁移、重构和能力建设的计划、执行过程和结果。
...
- `2026-08-docs-governance-rework`
- `2026-08-a2ui-action-event-migration`
...
- 新功能新增、功能修改、重构或迁移开始时，先创建计划目录，再改代码或权威文档。
- 计划中产生的长期事实必须迁移到产品、设计、契约或当前实现文档。
- 完成的计划不必移入归档，保留在 `50-delivery/planning/` 作为项目演进记录。
