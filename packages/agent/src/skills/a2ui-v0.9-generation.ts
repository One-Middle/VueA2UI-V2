...
const A2UI_GENERATION_STANDARDS_REFERENCE: SkillReference = {
  ...
  title: "A2UI 标准生成规则",
  description:
    "包含符合 Renderer 的完整消息结构、组件树、dataModel、List、表单、事件、JSRuntime、安全边界、bad case 和输出检查。",
  content: [
    "# A2UI 标准生成规则",
    "",
...
function buildHighQualityA2UIGoodCasesReference(): SkillReference {
  ...
  description:
    "适用于复杂 UI 或质量标杆场景；包含 Live Commerce（亮色电商）、Finance Brief（黑金金融）、Work Board（清爽工具）三个完整 good case，覆盖三种视觉范式。",
  content: [
    "# 高质量 A2UI Good Case",
    "",
